"""Validate mimir_analyzer logging works."""

import mock
import mimir_analyzer
...
def test_initialize_logging_default(get_logger, basic_cfg):
    ...
    mimir_analyzer.log.initialize_logging()
    ...
    assert get_logger.mock_calls[0].args == ("mimir_analyzer",)
...
def test_initialize_logging_user_defined_config(get_logger, basic_cfg):
    ...
    mimir_analyzer.log.initialize_logging(config=config)
...
def test_initialize_logging_filename(get_logger, basic_cfg):
    ...
    mimir_analyzer.log.initialize_logging(filename="output.log")
